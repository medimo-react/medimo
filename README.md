...
| 이름     | 문제점                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 해결 방법                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **유나** | MongoDB Atlas 연결 문자열은 보통 아래와 같은 `mongodb+srv` 형식을 사용.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Node 서버에서 사용할 DNS 서버를 직접 지정하여 해결. 기본 네트워크 DNS 대신 안정적인 공용 DNS 서버인 Google DNS와 Cloudflare DNS를 사용하도록 설정.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| **민혁** | 테스트를 위해 사용한 단순한 패턴의 취약 비밀번호가 브라우저의 유출 대조군에 포함되어 있었음. 서비스 측면에서의 비밀번호 유효성 검사가 부족함.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 정규표현식을 활용해 영문·숫자·특수문자 조합의 강력한 비밀번호 유효성 검사 로직을 도입하여 취약한 비밀번호 설정을 방지함.                                
