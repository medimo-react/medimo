...
| 이름     | 문제점                                                                                                                                                                                                                                                                                                                                            | 해결 방법                                                                                                                                                                                                                                                                                                                                                                                            |
| -------- |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **유나** | -   1. **약 이름 표시가 길어지는 문제**: 대시보드에서 약 이름과 괄호 안 성분명이 함께 표시되어 UI가 복잡해 보이는 문제 발생 </br> 2. **MongoDB Atlas 연결 실패 문제**: DB에 연결하려면 먼저 MongoDB 서버 주소를 찾아야 하는데, 일부 환경에서 그 주소를 제대로 못 찾는 문제가 있었음.                                                                                                                                                                                                                                                                                                                                         | 괄호 안 내용을 제거하고 대표 약 이름만 보여주도록 문자열 가공 처리                                                                                                                                                                                                                                                                                                                                                                                                |
| **현주** | -                                                                                                                                                                                                                                                                                                                                              | -                                                                                                                                                                                                                                                                                                                                                                                                |
